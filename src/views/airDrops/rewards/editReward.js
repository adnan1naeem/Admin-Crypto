...
const EditReward = () => {
    ...
    useEffect(() => {
        setFirstReward(data?.state?.item?.firstReward);
        setSecondReward(data?.state?.item?.secondReward);
        setThirdReward(data?.state?.item?.thirdReward);
        setForthReward(data?.state?.item?.forthReward);
        setFifthReward(data?.state?.item?.fifthReward);
        setAfterFifthReward(data?.state?.item?.afterFifthReward);
        setReward(data?.state?.item?.name);
        setCategory(data?.state?.item?.reward)
    }, [])
