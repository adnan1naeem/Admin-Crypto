...
const EditCategories = () => {
    ...
    useEffect(() => {
        setCategory(data?.state?.item?.name)
        setDescription(data?.state?.item?.description)
        setReward(data?.state?.item?.reward)
        setSponsoredBy(data?.state?.item?.sponsoredBy)
        setLogo(data?.state?.item?.logo)
    }, [])
    const handleBack = () => {
